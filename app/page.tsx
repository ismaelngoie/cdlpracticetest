...
export default function Home() {
  ...
  // ✅ FIX: read UTMs without useSearchParams (avoids Suspense prerender error)
  useEffect(() => {
    if (!mounted) return;
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-10 md:py-14">
        ...
        >
          ...
          <div className="flex items-start justify-between gap-4 mb-8">
            <div className="text-left">
              ...
              <div className="text-xs text-slate-400 mt-2 max-w-[460px] leading-relaxed">
                We auto-save your setup on this device so you can come back and continue instantly.
              </div>
            </div>
          ...
          <div className="mb-10">
            ...
            <div className="mt-3 text-[11px] text-slate-500 font-mono">
              State mode helps match DMV wording + rules.
            </div>
          </div>
