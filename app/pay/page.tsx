...
function PaywallContent() {
  ...
  // Scroll into embedded checkout when opened
  useEffect(() => {
  ...
  const stickyCtaText = useMemo(() => {
    return selectedPlan === "lifetime" ? "Pay once • Get lifetime access →" : "Start monthly • Get full access →";
  }, [selectedPlan]);
  ...
  // Mount Stripe Embedded Checkout inline on the page
  useEffect(() => {
    let cancelled = false;
